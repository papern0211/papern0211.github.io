...
![Fig. 1. Inception 모듈의 변경 및 해석]({{ site.url }}{{ site.baseurl }}/assets/images/2020-12-20-Xception/inception.jpg)
</br></br>
...
![Fig. 2. 비선형 activation에 따른 성능]({{ site.url }}{{ site.baseurl }}/images/2020-12-20-Xception/nonlinearity.jpg)
</br></br>
...
![Fig. 3. ImageNet 데이터에서 모델별 성능]({{ site.url }}{{ site.baseurl }}/assets/images/2020-12-20-Xception/results.jpg)
</br></br>
